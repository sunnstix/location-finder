...
from sunnyfileconvert import stateToNumber

NUMBER_TO_STATE = {v:k for k, v in stateToNumber.items()}
...
if __name__ == '__main__':
    ...
    with open('test_input.txt','r') as input:
        for idx,line in enumerate(input.readlines()):
            print("Line {}: {}".format(idx,NUMBER_TO_STATE(predict(classifier,line))))
